...
#ifndef __UTILS_CUDA_MODULEDLL_H_INCL__
#define __UTILS_CUDA_MODULEDLL_H_INCL__
...
*/
  ...
  */
  #if defined UtilsCUDA_EXPORTS
    #define UTILS_CUDA_MODULE_API __declspec(dllexport)
    #pragma warning (push)
    ...
    #define UTILS_CUDA_MODULE_API __declspec(dllimport)
  #else
    #define UTILS_CUDA_MODULE_API
  #endif
...
#endif  /* __UTILS_CUDA_MODULEDLL_H_INCL__ */